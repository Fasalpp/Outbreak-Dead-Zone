...
namespace SlimUI.ModernMenu{
	public class UISettingsManager : MonoBehaviour {
		...
		public TextMeshProUGUI hardKilltext;
		...
		public void  Start (){
			...
			var normalKillCount = PlayerPrefs.GetInt("NormalKillCount").ToString();
			var hardKillCount = PlayerPrefs.GetInt("HardKillCount").ToString();
			normalKilltext.text = "Highest Kill in NORMAL : " + normalKillCount;
			hardKilltext.text = "Highest Kill in HARD : " + hardKillCount;
		}
