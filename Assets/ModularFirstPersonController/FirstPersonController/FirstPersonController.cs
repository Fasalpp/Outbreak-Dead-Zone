...
public class FirstPersonController : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        mouseSensitivityX = PlayerPrefs.GetFloat("XSensitivity");
        mouseSensitivityY = PlayerPrefs.GetFloat("YSensitivity");
    ...
    private void Update()
    {
        ...
        if(cameraCanMove)
        {
            yaw = transform.localEulerAngles.y + Input.GetAxis("Mouse X") * mouseSensitivityX;
...
// Custom Editor
    ...
    public override void OnInspectorGUI()
    {
        ...
        fpc.mouseSensitivityX = EditorGUILayout.Slider(new GUIContent("Look Sensitivity", "Determines how sensitive the mouse movement is."), fpc.mouseSensitivityX, .1f, 10f);
        fpc.mouseSensitivityY = EditorGUILayout.Slider(new GUIContent("Look Sensitivity", "Determines how sensitive the mouse movement is."), fpc.mouseSensitivityY, .1f, 10f);
